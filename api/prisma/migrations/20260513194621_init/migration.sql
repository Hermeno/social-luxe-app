...
-- CreateEnum
CREATE TYPE "FriendshipDuration" AS ENUM ('ONE_DAY', 'THREE_DAYS', 'SEVEN_DAYS', 'THIRTY_DAYS', 'PERMANENT');
...
CREATE TABLE "Friendship" (
    ...
    "duration" "FriendshipDuration" NOT NULL,
...
-- CreateTable
CREATE TABLE "FriendshipHistory" (
    "id" TEXT NOT NULL,
    "userAId" TEXT NOT NULL,
    "userBId" TEXT NOT NULL,
    "duration" "FriendshipDuration" NOT NULL,
    ...
    CONSTRAINT "FriendshipHistory_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "FriendshipHistory" ADD CONSTRAINT "FriendshipHistory_userAId_fkey" FOREIGN KEY ("userAId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FriendshipHistory" ADD CONSTRAINT "FriendshipHistory_userBId_fkey" FOREIGN KEY ("userBId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
