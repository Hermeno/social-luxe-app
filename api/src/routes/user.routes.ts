...
router.post('/follow-many', followController.followMany)
router.put('/profile', upload.single('avatar'), userController.updateProfile)
router.put('/interests', userController.updateInterests)
router.put('/business', userController.updateBusinessProfile)
router.put('/social', userController.updateSocialLinks)
router.get('/:id', userController.getUserById)
router.get('/:id/posts', userController.getUserPosts)
router.get('/:id/mutuals', userController.getMutualConnections)
