      ...
      <ScreenEntry style={s.container}>
        ...
        <View style={s.form}>
          <PhoneInput defaultCode="AO" layout="first"
            ...
            textInputStyle={{ color: colors.gray800 }} codeTextStyle={{ color: colors.gray800 }}
...
const s = StyleSheet.create({
  ...
  link:     { color: colors.gray400, textAlign: 'center' }, linkBold: { color: colors.primary, fontWeight: '700' },
})
